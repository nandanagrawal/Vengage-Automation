  ...
  return (
    ...
    >
      ...
      <div className="ml-auto flex items-center gap-2">
        {/* QB status chip */}
        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/[0.07] bg-white/[0.03] text-xs text-slate-400">
            ...
            <>
              ...
              >
                <div className="px-4 py-3 border-b border-white/[0.06]">
                  ...
                  <p className="text-slate-500 text-xs mt-0.5">admin@vengage.io</p>
                </div>
                <div className="p-1.5">
                  {[
                    { label: "Settings", icon: "⚙" },
                  ...
                  <div className="border-t border-white/[0.06] mt-1 pt-1">
                    <button className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-colors text-left">
